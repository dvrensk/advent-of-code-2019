defmodule WireGridTest do
  ...
  test "example wire distances" do
    assert WireGrid.wire_distance("R8,U5,L5,D3", "U7,R6,D4,L4") == 30

    assert WireGrid.wire_distance(
             "R75,D30,R83,U83,L12,D49,R71,U7,L72",
             "U62,R66,U55,R34,D71,R55,D58,R83"
           ) == 610
  ...
  test "quiz 2" do
    assert WireGrid.wire_distance_from_file("input.txt") == 5672
  end
end
